			...
			<div class="row">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
					<div class="leftbar p-r-20 p-r-0-sm">
						...
						<form method="get">
							...
							<input class="s-text7 size6 p-l-23 p-r-50" type="text" id="busca" name="search" placeholder="Busca de produtos...">	
							</div>
						</form>
				...
				<div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
					...
					<span class="s-text8 p-t-5 p-b-5">
							Mostrando <?php echo $pagina ."-". $numPaginas?> of <?php echo $total?> resultados
						</span>
					</div>
					<!-- Pagination -->
					...
					for($i=1; $i<=$numPaginas; $i++){
						if($pagina == $i){
						 ...
						 ';
							...
							echo '
							<a href="?pagina='.$i.'" class="item-pagination flex-c-m trans-0-4">'.$i.'</a>
						';
						}
...
<!--===============================================================================================-->
    ...
    <script type="text/javascript">
    	$( "#add" ).click(function( event ) {
  		...
  		location.href = "product.php?acao=add&id="+<?php $produto['id'];?>
  	});
    </script>
